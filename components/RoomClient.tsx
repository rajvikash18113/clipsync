      ...
      <div className="animate-fade-up" style={{ display: "flex", flexWrap: "wrap", alignItems: "flex-start", justifyContent: "space-between", gap: 16, marginBottom: 28 }}>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center", gap: 8 }}>
          ...
          <a
            ...
            aria-label="View ClipSync source on GitHub"
          ...
          <a
            href="https://github.com/rajvikash18113/clipsync/pulls"
            target="_blank"
            rel="noopener noreferrer"
            className="btn-icon"
            title="Open a pull request — contributions welcome"
            aria-label="Open a pull request on GitHub — contributions welcome"
            style={{ width: 36, height: 36, color: "var(--text-secondary)" }}
          >
